...
function LogItem:__tostring()
	return string.format("LogItem<%*>", self._log._name)
end
...
function Log.new()
	...
	return Log.ForName(name)
end

function Log.ForName(scriptName: string)
